                ...
                <div className="card1">
                    <div className="cover-text-wrapper">
                        <h4 className="username">
                            Dear Priyam<span className="underline"></span>
                        </h4>
                    ...
                    <div className="userImg">
                        <img src={priyam} alt="Recipient's Photo" />
                    </div>
                ...
                <div className="card2">
                    <div className="card2-content">
                        ...
                        <div className="card2-message-text italic">
                            <article style={{ marginBottom: '8px' }}>Happy Birthday, Priyam ❤️<br /><br /></article>
                            <article style={{ marginBottom: '10px' }}>From the moment you came into this world, there was something about you that made life feel a little more beautiful.  You carry a kind of warmth that reaches places even words sometimes can't.  Some people simply have a way of making ordinary days feel softer, brighter, and a little more meaningful.<br /><br /></article>
                            <article style={{ marginBottom: '10px' }}>On your birthday, I just hope every chapter ahead brings you the kind of happiness you truly deserve. Through every storm and every sunny day, may there always be something that reminds you that you never have to face life feeling alone. Some bonds don't need promises or explanations; they simply remain, quietly and surely, through every tomorrow. And whenever life feels a little heavy, just remember there will always be someone standing by you with nothing but the best intentions for you.<br /><br /></article>
                            <article style={{ marginBottom: '10px' }}>Another year has quietly added to your journey, but somehow, the little girl with that same innocent heart and familiar ways is still there... <br /><br />
                                Growing up is beautiful, but never feel like you have to change the things that make you who you are. Keep that same kindness, that same craziness, and that same way of making everything around you feel a little happier. Years may change, responsibilities may grow, and life may take you in different directions, but some parts of you are worth keeping exactly the way they are. Happy Birthday.</article>
                        </div>
