...
const SmallLetter = () => {
    ...
    <div className="small-rajib-paper-content">
        ...
        <p>Hey Priyam,<br /><br />Just a little note to say — Happy Birthday! 🎂<br /><br />May ur birthday be as wonderful and filled with love as ur presence is in the lives of others. May Allah grant u everything ur heart longs for, turn ur dreams into reality, and bless you with all the happiness u deserve, Ameen..🤍<br /><br />You truly deserve the finest life, and that is exactly what I pray comes your way.💕</p>
    </div>
