...
const LoveLetter = () => {
    const lettersData = [
        ...
        },
        {
            id: 2,
            name: "Priyam Kumari",
            msg: "One picture from you can quietly make a normal day feel much better.",
        },
        {
            id: 3,
            name: "Priyam Kumari",
            msg: "Your laugh has a way of making everything around me feel a little lighter.",
        },
        {
            id: 4,
            name: "Priyam Kumari",
            msg: "Seeing your name in my notifications is always a small reason to smile.",
        },
        {
            id: 5,
            name: "Priyam Kumari",
            msg: "Some words may look simple, but coming from you, they always mean a little more to me."
        },
    ];
                ...
                <div className={`envelope ${openEnvelope ? "active" : ""}`}>
                    ...
                    <div className="munna envelope-flap text-black relative">
                        <div className='munna absolute left-1/2 top-[20%] -translate-x-1/2 flex items-center justify-center flex-col md:gap-y-2'>
                            <span className='munna font-sriracha md:text-2xl text-lg'>Envelope of Genuineness</span>
                            <span className='munna font-dancingScript md:text-3xl text-xl'>Dear Priyam</span>
                        </div>
                    </div>
